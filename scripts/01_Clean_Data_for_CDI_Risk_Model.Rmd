...
This file imports the first n=5000 lines of the following data, then cleans each dataset for next steps (exploration). \* Demographics and events (dm) \* Lab results (lab) \* Diagnoses (dx) \* Medication administration (med_admin)
