...
# Alternative method for string matching ABX and PPI 
```{r Alternative method for string matching using data.table::%like%, eval = FALSE}
# Create vector for names of common antibiotics
names_of_abx <- "VANCOMYCIN|CEFTRIAXONE|CEFEPIME|LEVOFLOXACIN|CIPROFLOXACIN"
